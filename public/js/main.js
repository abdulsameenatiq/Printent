...
/*------------------------------------------------------------------------------*/
    ...
    jQuery(document).ready(function () {
        jQuery(".prt_listimgbox_wrapper .prt_listimgbox_wrap").hover(
            function () {
                jQuery(
    ...
    jQuery(window).on("load", function (e) {
        ...
        function footerloop() {
            jQuery(".footer_customheading .active").each(function (index) {
                ...
                var $next =
                    $this.next().length > 0 ? $this.next() : $li.first();
        ...
        setInterval(function () {
            footerloop();
        }, 2000); //timer running every 2 seconds
    });
